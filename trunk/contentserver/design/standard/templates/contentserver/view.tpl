<form name="contentserver" method="post" action={"contentserver/view"|ezurl}>

<div class="context-block">

{* DESIGN: Header START *}<div class="box-header"><div class="box-tc"><div class="box-ml"><div class="box-mr"><div class="box-tl"><div class="box-tr">

<h1 class="context-title">{'Imported Objects'|i18n( 'contentserver' )}</h1>
...
<div class="left">
    <p>
        ...
        <span class="current">Imports</span>
        <a href={'contentserver/client'|ezurl}>Webclient</a>
    </p>
</div>
<div class="break"></div>

<p>This interface shows all imported content objects.</p>
