...
<div class="element">
 {let selectedUsers=$event.selected_users}
    <label>{"Editor"|i18n("design/standard/workflow/eventtype/edit")}</label><div class="labelbreak"></div>
     <select name="WorkflowEvent_event_ezcontentserverapprove_editor_{$event.id}[]" size="5">
...
<div class="element">
 {let selectedSections=$event.selected_sections}
    ...
    <select name="WorkflowEvent_event_ezcontentserverapprove_section_{$event.id}[]" size="5" multiple >
     <option value="-1" 
    {switch match=-1}
...
<div class="element">
 {let selectedGroups=$event.selected_usergroups}
     ...
     <select name="WorkflowEvent_event_ezcontentserverapprove_groups_{$event.id}[]" size="5" multiple >
     <option value="-1" 
    {switch match=-1}
