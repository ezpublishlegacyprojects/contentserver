...
$list =& eZContentServerImport::fetchObjectList(eZContentServerImport::definition(), null, $cond, array(  'created'=> 'desc' ) );
...
$Result = array();
$Result['content'] =& $tpl->fetch( "design:contentserver/view.tpl" );
$Result['path'] = array( array( 'url' => false,
                                'text' => ezi18n( 'contentserver', 'Contentserver' ) ),
                         array( 'url' => false,
                                'text' => ezi18n( 'contentserver', 'Imported Objects' ) ) );
